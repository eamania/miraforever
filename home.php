...
get_header(); ?>
<!--START sezione news nella zona alta nella home page -->
    ...
    <div class="row">
        ...
        <div id="primary" class="content-area col-md-9">
            <main id="main" class="site-main" role="main">
                ...
                <section class="row">
					<span id="" class="col-md-6 content-article-box">
						<span ><?php
...
<!--  END news nella zona alta nella home page -->
...
<div class="container-fluid">
    ...
    <section id="mappa_carousel" class="row carousel-home-page">
        <div id="mappa" class="container-fluid attrazioni-display mappa-home-page carousel-div">
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2"><a
                        href="http://mirabilandia.it/sites/mirabilandia.it/files/Fronte_mappa_2015_ESEC_zoom.jpg"><img
                            class="img-responsive"
                            src="<?php echo get_template_directory_uri() . '/image/mappacentro.jpg' ?>"></a></div>
            </div>
...
<!--END sezione larga con attrazioni e spettacoli ecc-->
