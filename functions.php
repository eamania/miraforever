...
function miraforever_widgets_init()
{
    ...
    register_sidebar(array(
        'name' => __('attrazioni', 'miraforever'),
        'id' => 'attrazioni',
        'description' => '',
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
    ...
    register_sidebar(array(
        'name' => __('attrazioni_rimosse', 'miraforever'),
        'id' => 'attrazioni_rimosse',
        'description' => '',
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
        'before_title' => '<h1 class="widget-title">',
    ...
    register_sidebar(array(
        'name' => __('spettacoli', 'miraforever'),
        'id' => 'spettacoli',
        'description' => '',
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
    ...
    register_sidebar(array(
        'name' => __('spettacoli_rimossi', 'miraforever'),
        'id' => 'spettacoli_rimossi',
        'description' => '',
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
        'before_title' => '<h1 class="widget-title">',
